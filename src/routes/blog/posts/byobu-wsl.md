...
![Check to see if byobu is installed](/images/byobucheck.png)

Once installed it's easy to start a session, just type the `byobu` command:
![A New Byobu Session](/images/byobuopen.png) 
...
![A single byobu window](/images/byobunvim.png)
...
![a second byobu window](/images/byobuwin.png)
...
![a second byobu window](/images/byobusplit.png)
